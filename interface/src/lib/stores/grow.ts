...
export const createArbExchange1: Writable<string | undefined> = writable()
export const createArbExchange2: Writable<string | undefined> = writable()
...
export const createArbAmount = writable<any[]>([])

// Create new just grow
export const createSimplyGrowAsset = writable<SimplyGrowToken | undefined>()
...
export const createAIAssets = writable<any[]>([])
export const createAIAmounts = writable<any[]>([])
