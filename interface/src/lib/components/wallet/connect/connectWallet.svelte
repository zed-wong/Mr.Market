...
<div
    class="flex flex-col items-center justify-center space-y-6 mb-24 h-full grow"
>
    <svg
        class="w-32"
        viewBox="0 0 142 151"
    ...
    <span class="font-bold">
        {$_("connect_wallet_balance_intro")}
    </span>
    <ConnectWalletBtn clazz="bg-slate-800 text-base-100 hover:bg-slate-800" />
</div>
