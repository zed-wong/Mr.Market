...
{#if name === "dashboard"}
  <svg
    class="w-6 h-6 text-current opacity-80 transition-colors duration-200"
    fill="currentColor"
    viewBox="0 0 20 20"
...
{:else if name === "users"}
  <svg
    class="w-6 h-6 text-current opacity-80 flex-shrink-0 transition-colors duration-200"
    fill="currentColor"
    viewBox="0 0 20 20"
    xmlns="http://www.w3.org/2000/svg"
  >
