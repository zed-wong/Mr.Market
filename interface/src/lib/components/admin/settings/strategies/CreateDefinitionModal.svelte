        ...
        <div class="flex gap-3">
          <div class="flex-1 bg-base-200/40 rounded-xl p-4">
            ...
            <input
              ...
              class="input input-bordered w-full h-10 min-h-[40px] bg-base-100 text-base-content text-sm focus:outline-none focus:border-primary border-base-300 font-mono"
              bind:value={key}
            />
          </div>
          <div class="flex-1 bg-base-200/40 rounded-xl p-4">
