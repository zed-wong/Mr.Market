<script lang="ts">
    ...
    $: campaignType = formatCampaignType(
        ...
        >
            <div class="bg-primary/5 px-7 pb-6 pt-7">
                ...
                <div class="mt-5 flex flex-col gap-2">
                    <span
                        class="text-[1.7rem] font-bold leading-tight text-base-content"
                    >
                        {campaignName}
                    </span>
                    <div class="flex items-center gap-2">
                        <span
                            class={`h-2 w-2 rounded-full ${statusDot(status)}`}
                        ></span>
                        <span
            ...
            <div class="px-7 pb-7 pt-6">
                ...
                <div class="mt-6 flex flex-col gap-4">
                    <label class="form-control w-full">
                        ...
                        <div
                            class="flex min-h-12 items-center gap-2 rounded-xl bg-primary/5 px-4"
                        >
                            <span
                            ...
                            >
                                {joinCampaignEvmAddress ||
                                    $_(
                                        "admin_direct_mm_evm_address_placeholder",
                                    )}
                            </span>
                ...
                <div class="mt-7 flex items-center justify-end gap-4">
                    ...
                    <button
                        class="btn btn-primary gap-2 px-6 font-semibold text-primary-content"
                        disabled={isJoiningCampaign || readOnlyKeys.length === 0}
                        on:click={onConfirm}
                    >
                        <span
                            >{isJoiningCampaign
