                            ...
                            <div class="flex items-center gap-2">
                                ...
                                {#if campaign.address}
                                    <button
                                        ...
                                        on:click={() => window.open(`https://dashboard.hu.finance/campaign-details/${campaign.address}`, '_blank')}
                                        aria-label={$_("admin_direct_mm_details")}
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15m0-3-3-3m0 0-3 3m3-3V15" />
                                        </svg>
                                    </button>
                                    <div class="tooltip tooltip-bottom flex items-center" data-tip={copiedAddress === String(campaign.address) ? $_("copied") : $_("admin_direct_mm_copy_address")}>
                                        <button
                                            class="flex items-center text-base-content/40 hover:text-primary"
                                            on:click={() => copyAddress(String(campaign.address))}
