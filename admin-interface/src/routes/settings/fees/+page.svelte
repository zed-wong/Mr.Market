...
<div class="p-4 sm:p-6 md:p-8 space-y-5 sm:space-y-6 max-w-7xl mx-auto">
    ...
    >
        ...
        >
            ...
            >
                <span class="text-xl sm:text-2xl font-bold">{$_("fees")}</span>
        ...
        <button
            class="btn btn-square btn-outline self-end sm:self-auto"
            on:click={() => RefreshFees(true)}
        >
            <span
                class={clsx(
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-control w-full">
                            ...
                            >
                                <input
                                    ...
                                    class="toggle toggle-primary toggle-sm"
                                    bind:checked={
                                        globalFee.enable_market_making_fee
                                    }
                                />
                                <span class="label-text"
                                    >{$_("enable_market_making_fee")}</span
                                >
                            </label>
                        </div>
                        ...
                        <div class="card-actions justify-end mt-6">
                            <button
                                ...
                                on:click={() => openModalById("confirm_modal")}
                            >
                                <span
                                    class={clsx(
                                        isUpdating &&
                    ...
                    <div class="card-body p-0">
                        ...
                        >
                            ...
                            <button
                                ...
                                on:click={() =>
                                    openModalById("add_override_modal")}
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                        ...
                        {#if feeOverrides.length === 0}
                            ...
                            >
                                ...
                                <p
                                    class="text-lg font-medium text-base-content/60"
                                >
                        ...
                        {:else}
                            <div class="overflow-x-auto">
                                <table class="table table-lg">
                                    <thead
                                        class="bg-base-200/50 text-base-content/70"
                                    >
                                        <tr>
                                            <th
                                            ...
                                            >
                                            <th
                                                class="text-right uppercase text-xs font-semibold"
                                                >{$_("actions")}</th
                                            >
                                        </tr>
                                    </thead>
