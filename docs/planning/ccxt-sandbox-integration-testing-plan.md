...
Update `docs/planning/README.md` so the planning index describes this file as the production-parity sandbox execution plan rather than only adapter-level coverage.
