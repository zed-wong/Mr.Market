...
This directory is organized by document responsibility, not by author or date.
...
- `docs/AGENTS.md` remains here as repository collaboration guidance
- Historical plans stay under `archive/` unless they are still driving active work
