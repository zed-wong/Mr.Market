...
| `server/src/common/entities/market-making/strategy-instances.entity.ts` | `StrategyInstance` | Durable strategy runtime session metadata (`strategyKey`, params, status). | `modules/market-making/strategy/strategy.service.ts` | 5, 6 |
...
| `server/src/common/entities/orders/trade.entity.ts` | `Trade` | Stores general trade records for the trade module. | `modules/market-making/trade/*` | 7, 8 |
