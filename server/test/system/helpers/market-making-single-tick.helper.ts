...
import { EfficientDualAccountVolumeStrategyController } from 'src/modules/market-making/strategy/controllers/efficient-dual-account-volume-strategy.controller';
    ...
    this.moduleRef = await Test.createTestingModule({
      ...
      providers: [
        ...
        },
        {
          ...
          useFactory: (
            dualAccountVolumeController: EfficientDualAccountVolumeStrategyController,
