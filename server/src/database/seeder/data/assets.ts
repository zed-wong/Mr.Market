 ...
 *
 * chain_id: The chain this asset belongs to (for native assets, chain_id === asset_id)
 * chain_icon_url: The icon of the chain (for display purposes)
 */
export const POPULAR_ASSETS = {
  ...
  SOL: {
    ...
    chain_id: '64692c23-8971-4cf4-84a7-4dd1271dd887', // Solana chain
    name: 'Solana',
    symbol: 'SOL',
    icon_url:
  ...
  XRP: {
    ...
    chain_id: '23dfb5a5-5d7b-48b6-905f-3970e3176e27', // Ripple chain
    name: 'XRP',
    symbol: 'XRP',
    icon_url:
  ...
  DOGE: {
    ...
    chain_id: '6770a1e5-6086-44d5-b60f-545f9d9e8ffd', // Dogecoin chain
    name: 'Dogecoin',
    symbol: 'DOGE',
    icon_url:
  ...
  LTC: {
    ...
    chain_id: '76c802a2-7c88-447f-a93e-c29c9e5dd9c8', // Litecoin chain
    name: 'Litecoin',
    symbol: 'LTC',
    icon_url:
  ...
  AVAX: {
    ...
    chain_id: 'cbc77539-0a20-4666-8c8a-4ded62b36f0a', // Avalanche chain
    name: 'Avalanche',
    symbol: 'AVAX',
    icon_url:
  ...
  // Stablecoins (tokens on Ethereum chain)
  USDT: {
  ...
  BNB: {
    ...
    chain_id: '1949e683-6a08-49e2-b087-d6b72398588f', // BSC chain
    name: 'BNB',
    symbol: 'BNB',
    icon_url:
  ...
  MATIC: {
    ...
    chain_id: 'b7938396-3f94-4e0a-9179-d3440718156f', // Polygon chain
    name: 'Polygon',
    symbol: 'MATIC',
    icon_url:
    ...
    chain_icon_url:
      'https://images.mixin.s128',
  },
  ...
  XIN: {
    ...
    chain_id: 'c94ac88f-4671-3976-b60a-09064f1811e8', // Mixin chain
    name: 'Mixin',
    symbol: 'XIN',
    icon_url:
