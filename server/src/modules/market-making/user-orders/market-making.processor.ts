...
export class MarketMakingOrderProcessor {
  ...
  private async executeRefundTransfer(command: RefundTransferCommand): Promise<void> {
  ...
  private async compensateRefundDebit(command: RefundTransferCommand): Promise<void> {
    try {
