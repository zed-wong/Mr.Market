...
/**
 * @deprecated Use TimeIndicatorStrategyController and StrategyService instead.
 * This service is kept for reference but the loop-based execution has been
 * replaced by the tick-driven StrategyController pattern.
 */
@Injectable()
